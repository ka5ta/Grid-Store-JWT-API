...
class AuthenticationControllerTest {
    ...
    private final Account USER_ACCOUNT_1_OUTPUT = new Account(1L, "user@email.com", passwordEncoder.encode("123456"), new HashSet<>(Collections.singleton(Role.USER)));
    private final Account ADMIN_ACCOUNT_2_OUTPUT = new Account(2L, "admin@email.com", passwordEncoder.encode("654321"), new HashSet<>(Collections.singleton(Role.ADMIN)));
    ...
    class registerAuthenticationControllerTest {
        ...
        void anonymousCanRegisterTest() throws Exception {
            ...
            mvc
                    ...
                    .andDo(print())
                    .andExpect(jsonPath("$.account.email", org.hamcrest.Matchers.is("user@email.com")))
        ...
        void emailAlreadyRegisteredThrowTest() throws Exception {
            ...
            //Mock
            when(jwtUserDetailsServiceMock.save(any(RegisterAccountDTO.class))).thenThrow(new AccountException(ACCOUNT_EXISTS_EXCEPTION));
    ...
    class generateTokenAuthenticationTest {
        ...
        void existentUserCanGetTokenAndAuthenticationTest() throws Exception {
            ...
            //Mock
            when(jwtUserDetailsServiceMock.loadUserByUsername(JWT_USER_AUTH_REQUEST_1.getEmail())).thenReturn(USER_DETAILS_1);
        ...
        void anonymousNotAllowedToGetTokenTest() throws Exception {
            ...
            //Mock
            when(jwtUserDetailsServiceMock.loadUserByUsername(JWT_USER_AUTH_REQUEST_1.getEmail())).thenThrow(UsernameNotFoundException.class);
