...
public class JsonErrorResponseHandler {
    ...
    public static void jsonErrorResponseIssuer(HttpServletResponse response, String errorMessage, int errorCode) throws IOException {
    ...
    public static String createJsonErrorMessage(String errorMessage) {
        Gson gson = new GsonBuilder()
                .setPrettyPrinting()
                .serializeNulls()
                .setDateFormat("dd/MM/yyyy HH:mm:ss zzz")
                .registerTypeAdapter(Instant.class, new InstantAdapter())
                .create();

        return gson.toJson(new ErrorResponseDTO(errorMessage));
    }
}
